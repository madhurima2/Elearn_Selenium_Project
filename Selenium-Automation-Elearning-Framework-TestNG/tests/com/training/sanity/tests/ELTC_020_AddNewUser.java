...
public class ELTC_020_AddNewUser {
	...
	public void validLoginTest() {
		addUserTestPOM.sendUserName("admin");
		addUserTestPOM.sendPassword("admin@123");
	...
	public void AddUserTrainerTest() { 
		addUserTestPOM.AddUser(); 
		screenShot.captureScreenShot("Add user  Page Opened");
	}
