...
public class ELTC_074_InvalidDetails {

	private WebDriver driver;
	private String baseUrl;
	//private LoginPOM loginPOM;
	private ELearnPOM eLearnPOM;
	private AddUserELearnPOM addUserElearnPOM;
	...
	@AfterMethod
	public void invalidCreateCourseTest() {
		addUserElearnPOM.createCategoryCourse(); 
		screenShot.captureScreenShot("Course Category");
	}
	@AfterTest
